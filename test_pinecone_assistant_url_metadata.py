...
class TestPineconeAssistantURLMetadata(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('src.agents.pinecone_assistant_agent.Config') as mock_config:
    ...
    def test_upload_documents_with_url_metadata(self, mock_post):
        ...
        self.assertEqual(uploaded_docs[0]['metadata']['url'], 'https://example.com/doc1')
        self.assertEqual(uploaded_docs[0]['metadata']['published'], '2024-01-01')
        
        # Verify second document has sanitized URL
        self.assertEqual(uploaded_docs[1]['metadata']['url'], 'https://example.com/doc2')
    ...
    def test_format_sources_with_urls(self):
        ...
        self.assertEqual(second_source['content'], 'This is the content from document 2')
    ...
    def test_query_assistant_with_url_metadata(self, mock_post):
        ...
        # Verify the answer
        self.assertEqual(result['answer'], 'This is the assistant response about Bitcoin.')
        ...
        self.assertEqual(second_source['url'], 'https://lightning.network/lightning-network-paper.pdf')
