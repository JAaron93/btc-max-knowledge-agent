...
class TestIsSecureUrl:
    ...
    def test_private_ip_addresses(self):
        ...
        for url in private_ip_urls:
            assert not is_secure_url(url), f"Should block private IP URL: {url}"
    ...
    def test_long_urls(self):
        ...
        assert not is_secure_url(long_url), "Should reject URL exceeding max length"
...
class TestNormalizeUrlRfc3986:
    ...
    def test_case_normalization(self):
        ...
        case_urls = [
            ...
            ("HTTP://API.EXAMPLE.COM:8080/PATH", "http://api.example.com:8080/PATH"),
        ]
    ...
    def test_query_and_fragment_encoding(self):
        ...
        encoding_urls = [
            ...
            ("https://example.com#section name", "https://example.com/#section%20name"),
    ...
    def test_invalid_inputs(self):
        ...
        for input_val in invalid_inputs:
            ...
            assert result is None, f"Should return None for invalid input: {input_val}"
...
class TestSanitizeUrlForStorage:
    ...
    def test_edge_cases(self):
        ...
        for input_url, expected in edge_cases:
            result = sanitize_url_for_storage(input_url)
            assert result == expected, f"Expected {expected} for edge case: {input_url}"
...
class TestCheckUrlsAccessibilityParallel:
    ...
    def test_parallel_accessibility_check(self, mock_head):
        ...
        results = check_urls_accessibility_parallel(urls, timeout=5, max_workers=3)
    ...
    def test_timeout_handling(self, mock_head):
        ...
        results = check_urls_accessibility_parallel(urls, timeout=1, max_workers=2)
    ...
    def test_performance_with_many_urls(self):
        ...
        with patch("src.utils.url_utils.check_url_accessibility") as mock_check:
...
class TestCheckUrlAccessibility:
    ...
    def test_inaccessible_url_various_codes(self, mock_session):
        ...
        for code in status_codes:
            ...
            result = check_url_accessibility(
                f"https://example.com/{code}", _use_session=True
            )
    ...
    def test_inaccessible_url_various_codes_no_session(self, mock_head):
        ...
        for code in status_codes:
            ...
            result = check_url_accessibility(
                f"https://example.com/{code}", _use_session=False
            )
            assert result is False, f"Should be inaccessible for status {code}"
    ...
    def test_redirect_handling(self, mock_session):
        ...
        result = check_url_accessibility(
            "https://example.com/redirect", _use_session=True
        )
        assert result is True
    ...
    def test_redirect_handling_no_session(self, mock_head):
        ...
        result = check_url_accessibility(
            "https://example.com/redirect", _use_session=False
        )
        assert result is True
    ...
    def test_invalid_url_format(self):
        ...
        for url in invalid_urls:
            ...
            assert result is False, f"Should return False for invalid URL: {url}"
    ...
    def test_custom_timeout_with_session(self, mock_session):
        ...
        ), "Custom timeout not passed to request with session"
    ...
    def test_custom_timeout_no_session(self, mock_head):
        ...
        assert (
            kwargs.get("timeout") == 10
        ), "Custom timeout not passed to request without session"
...
class TestFormatUrlForDisplay:
    ...
    def test_long_url_with_domain(self):
        ...
        long_url = (
            "https://example.com/very/long/path/that/exceeds/the/"
    ...
    def test_long_url_without_domain(self):
        ...
        with patch("src.utils.url_utils.extract_domain", return_value=None):
            long_url = "https://very-long-domain-name-that-exceeds-limit" ".com/path"
            result = format_url_for_display(long_url, max_length=30)
...
class TestLocalhostUrlConfig:
    """Tests for localhost URL handling based on ALLOW_LOCALHOST_URLS config flag."""

    @patch.dict(os.environ, {"ALLOW_LOCALHOST_URLS": "True"}, clear=True)
    ...
    def test_localhost_rejected_when_disabled(self):
        ...
        localhost_urls = [
            ...
            # "http://*********",  # 127.0.0.1 - this gets blocked as private IP
            # "https://*********:8080",
        ]
    ...
    def test_batch_validation_with_localhost_allowed(self):
        ...
        urls = [
            ...
            "https://localhost/api",  # Should be valid when allowed
            "javascript:alert(1)",  # Still dangerous
        ]
    ...
    def test_batch_validation_with_localhost_rejected(self):
        ...
        urls = [
            ...
            "https://localhost/api",  # Should be rejected when disabled
            "javascript:alert(1)",  # Still dangerous
        ]
