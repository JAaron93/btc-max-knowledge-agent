...
class TestResponseContentExtractor:
    ...
    def test_extract_main_content_with_markdown(self):
        ...
        **Bitcoin** is a *decentralized* digital currency.
        ...
        assert (
            "Bitcoin is a decentralized digital currency." in result
        )  # Bold/italic removed
    ...
    def test_extract_from_structured_response_answer_format(self):
        ...
        result = ResponseContentExtractor.extract_from_structured_response(
            response_data
        )
...
class TestAudioFormatConverter:
    ...
    def test_prepare_for_streaming(self):
        ...
        chunks = list(
            AudioFormatConverter.prepare_for_streaming(audio_bytes, chunk_size)
        )
    ...
    def test_create_gradio_audio_component_data(self):
        ...
        result = AudioFormatConverter.create_gradio_audio_component_data(
...
class TestErrorHandling:
    ...
    def test_error_logging(self):
        ...
        with pytest.raises(
            ContentExtractionError, match="Invalid response text provided"
        ):
            ResponseContentExtractor.extract_main_content(None)
...
class TestEdgeCases:
    ...
    def test_empty_structured_response_fields(self):
        ...
        response_data = {"answer": "", "content": "", "sources": []}
