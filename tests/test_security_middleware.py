...
from src.security.interfaces import ISecurityValidator, ISecurityMonitor
...
class TestMiddlewareIntegration:
    ...
    @pytest.mark.asyncio
    async def test_async_middleware_behavior(self, mock_validator, mock_monitor, security_config):
        ...
        response = client.post(
            "/async-endpoint",
            json={"data": "test async processing"}
        )
