...
class TestBuildUploadPayload(unittest.TestCase):
    ...
    def test_build_upload_payload_null_safe_metadata_handling(self):
        ...
        for field in ["title", "source", "category", "url", "published"]:
            self.assertEqual(metadata[field], "", f"Field {field} should be empty string, not None")
    ...
    def test_build_upload_payload_with_special_characters(self):
        ...
        self.assertEqual(result["text"], "Content with special chars: üñíçödé, emojis 🚀, and symbols @#$%")
        self.assertEqual(result["metadata"]["title"], "Special Characters Test: éñ español")
    ...
    def test_build_upload_payload_metadata_structure_consistency(self):
        ...
        test_docs = [
            ...
            {"id": "doc4", "content": "Content 4", "title": "Title 4", "source": "Source 4", "category": "Category 4", "url": "https://example.com/4", "published": "2024-01-01"}
        ]
        ...
        for doc in test_docs:
            ...
            for field in required_metadata_fields:
                ...
                self.assertIsInstance(result["metadata"][field], str,
