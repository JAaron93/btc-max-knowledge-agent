...
def demo_visual_states():
    ...
    def get_tts_status_display(is_synthesizing=False, has_error=False, error_info=None, 
                              is_loading=False, is_playing=False, is_cached=False):
        if has_error:
    ...
    print("   " + get_tts_status_display(has_error=True, error_info={"error_type": "API_ERROR"}))
    print("   Features:")
