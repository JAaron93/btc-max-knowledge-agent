...
class QueryRequest(BaseModel):
    question: str = Field(..., min_length=1, max_length=1000, description="Bitcoin-related question")
...
def create_secure_bitcoin_api() -> FastAPI:
    ...
    async def security_status():
        ...
        try:
            ...
            if security_state["validator"]:
                ...
                try:
                    validator_libraries = security_state["validator"].get_library_status()
            ...
            if security_state["monitor"]:
                ...
                try:
                    monitor_metrics = await security_state["monitor"].get_security_metrics()
                except Exception as e:
    ...
    async def security_health():
        ...
        try:
            ...
            if security_state["validator"]:
                try:
                    library_health = await security_state["validator"].check_library_health()
                    validator_health = {
                ...
                validator_health = {"healthy": False, "error": "Validator not initialized"}
                overall_status = "unhealthy"
    ...
    async def health_check():
        return {
            "status": "healthy",
            "security_middleware": "active" if security_enabled else "inactive"
        }
