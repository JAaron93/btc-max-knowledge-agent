...
class URLMetadataDemo:
    ...
    def _get_sample_sources(self) -> List[Dict[str, str]]:
        ...
        return [
            ...
            },
            {
                ...
                'content': ('Ethereum is a decentralized platform that runs '
                            'smart contracts...')
            }
        ]
    ...
    def _process_source_with_fallback(self, source: Dict[str, Any]
                                      ) -> Dict[str, Any]:
    ...
    def demonstrate_concurrent_operations(self,
                                          data: List[Dict[str, Any]]) -> List[Dict[str, str]]:
        ...
        with ThreadPoolExecutor(max_workers=3) as executor:
            futures = {
                executor.submit(process_data_item, item): item
                for item in data
            }
    ...
    def demonstrate_query_and_retrieval(self, mock_mode: bool = True
        ...
        if mock_mode:
            ...
            formatted_response = self.result_formatter.format_response(
                ...
                model_answer=("The Lightning Network is a Layer 2 scaling "
            ...
            self.logger.log_query_execution(
                ...
                has_url_metadata=sum(
                    1 for r in mock_results 
                    if 'source_url' in r.get('metadata', {})
                ),
                correlation_id=self.correlation_id
            )
    ...
    def demonstrate_monitoring_and_metrics(self):
        ...
        duration = (datetime.utcnow() -
                    self.demo_metrics['start_time']).total_seconds()
