...
if src_path.exists() and src_path.is_dir():
    ...
    print("Please ensure the script is run from the correct location or adjust the path.")
...
async def main():
    ...
    try:
        ...
        if len(cached_audio) == len(audio_data) and cached_audio[:100] == audio_data[:100]:
