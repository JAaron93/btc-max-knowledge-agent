...
def is_session_expired(session_id: str, 
    ...
    Args:
        ...
        session_created_at: When session was created (None for demo)
...
def validate_session_ownership(current_session_id: Optional[str], 
                             requested_session_id: Optional[str],
                             client_ip: str = "unknown") -> Tuple[bool, int, str]:
    """
    ...
    if not current_session_id.strip():
        ...
        return (False, 401, 
                "Invalid session format. Session access requires a valid "
                "session cookie.")
    ...
    if not requested_session_id:
        ...
        return (False, 400, 
                "Bad request. Session ID parameter is required.")
    ...
    if not validate_session_id_format(current_session_id):
        ...
        return (False, 401, 
                "Invalid session format. Please log in again.")
    ...
    if not validate_session_id_format(requested_session_id):
        ...
        return (False, 400, 
                "Invalid session ID format in request.")
    ...
    if is_session_expired(requested_session_id):
        ...
        return (False, 410, 
                "Requested session has expired and is no longer available.")
